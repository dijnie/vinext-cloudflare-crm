...
import { createFieldsGetHandler, createFieldsPostHandler, createFieldsPatchHandler } from "../../app/api/crm/fields/route";
import { createFieldGetHandler, createFieldPatchHandler, createFieldDeleteHandler } from "../../app/api/crm/fields/[fieldId]/route";
import { createFieldValuesGetHandler, createFieldValuesPatchHandler } from "../../app/api/crm/fields/values/route";
import { createCompaniesPostHandler, createCompaniesGetHandler } from "../../app/api/crm/companies/route";
import { createContactsPostHandler, createContactsGetHandler } from "../../app/api/crm/contacts/route";
import { createDealsPostHandler, createDealsGetHandler } from "../../app/api/crm/deals/route";
import { createMemberDeleteHandler } from "../../app/api/crm/members/[memberId]/route";
