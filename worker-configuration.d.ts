/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6d63b8c6a36d6bccfe6862e94b9a9236)
...
interface __BaseEnv_Env {
	...
	CUSTOMER_WORKFLOW: Workflow<Parameters<import("./worker/index").CustomerWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_EMAIL_FROM" | "BETTER_AUTH_SECRET" | "AUTH_BASE_URL">> {}
}
