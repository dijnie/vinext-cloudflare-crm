import { z } from "zod";
import { currencyCodeSchema, dealConversionOutputSchema } from "@/modules/currency/currency-contracts";
import { fieldDefinitionSchema, fieldValuesSchema } from "@/modules/fields/field-contracts";
