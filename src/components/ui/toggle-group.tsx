...
function ToggleGroup({
	...
	return (
		<ToggleGroupPrimitive.Root
			...
			className={cn(
				"group/toggle-group flex w-fit flex-row items-center gap-[calc(var(--gap)*0.25rem)] rounded-md data-[size=sm]:rounded-md data-[orientation=vertical]:w-full data-[orientation=vertical]:flex-col data-[orientation=vertical]:items-stretch",
				className,
			)}
			{...props}
		>
