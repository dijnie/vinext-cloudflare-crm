	...
	return (
		<TabsPrimitive.Trigger
			...
			className={cn(
				...
				"data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-2xs dark:data-[state=active]:border-border dark:data-[state=active]:bg-accent dark:data-[state=active]:text-foreground",
