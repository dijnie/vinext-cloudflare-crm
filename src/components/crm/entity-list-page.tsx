...
import { entityPaths, parseListState, type EntityType } from "@/crm/list-state";
import type { CompanyListInput } from "@/crm/contracts/company-contract";
import type { ContactListInput } from "@/crm/contracts/contact-contract";
