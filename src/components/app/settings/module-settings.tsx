...
export function ModuleSettings({ initialData, locale }: { initialData: Settings; locale: AppLocale }) {
  ...
  return <section className="crm-page"><div><h1 className="crm-page-title">{labels.title}</h1><p className="mt-2 text-sm text-muted-foreground">{labels.description}</p></div>
