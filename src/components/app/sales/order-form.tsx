...
export function OrderForm({ record: initialRecord, fixedContact, submitCreate, locale, labels: crm, readOnly, onSaved, onCancel }: { record?: CrmRecord; fixedContact?: CrmRecord; submitCreate?: (data: Record<string, unknown>) => Promise<{ id: string }>; locale: AppLocale; labels: CrmDictionary; readOnly?: boolean; onSaved: (id: string) => void; onCancel: () => void }) {
