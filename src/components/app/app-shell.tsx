...
export function AppShell({ children, dictionary, locale, role, slug, user }: {
  ...
  const settings = [{ href: `${base}/settings/currencies`, label: currency.currencies }, { href: `${base}/settings/general`, label: getBusinessSettingsDictionary(locale).title }, ...(role === "owner" ? [{ href: `${base}/settings/catalog`, label: getCatalogDictionary(locale).categories }, { href: `${base}/settings/leads`, label: getLeadDictionary(locale).title }, { href: `${base}/settings/lead-conversion`, label: getLeadDictionary(locale).mapping }, { href: `${base}/settings/deal-stages`, label: getDealStageDictionary(locale).title }, { href: `${base}/settings/layouts`, label: getLayoutDictionary(locale).title }, { href: `${base}/settings/modules`, label: modules.labels.title },{ href: `${base}/settings/members`, label: dictionary.navigation.members }, { href: `${base}/settings/access`, label: getAccessDictionary(locale).title }, { href: `${base}/settings/operations`, label: locale === "vi" ? "Tích hợp và vận hành" : "Integrations and operations" }] : [])];
  const links = [
