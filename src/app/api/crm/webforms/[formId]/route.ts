...
export const createWebformPatchHandler = (
  ...
  createRouteHandler(root, {
    ownerOnly: true,
    unsafe: true,
    input: webformUpdateSchema.omit({ id: true }),
    handle: ({ context, input }) =>
      root.webforms.update(context, { ...input, id: formId }),
  });
export async function PATCH(
  ...
  return createWebformPatchHandler(
