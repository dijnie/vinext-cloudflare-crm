...
const en = {
  ...
  entities: { company: "Companies", contact: "Contacts", deal: "Deals", lead: "Leads", product: "Catalog" },
};
...
const vi: ModuleDictionary = {
  ...
  entities: { company: "Công ty", contact: "Liên hệ", deal: "Cơ hội", lead: "Tiềm năng", product: "Danh mục" },
};
