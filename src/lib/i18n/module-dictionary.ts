...
const en = {
  ...
  entities: { company: "Companies", contact: "Contacts", deal: "Deals", lead: "Leads", product: "Catalog", order: "Orders" },
};
...
const vi: ModuleDictionary = {
  ...
  entities: { company: "Công ty", contact: "Liên hệ", deal: "Cơ hội", lead: "Tiềm năng", product: "Danh mục", order: "Đơn hàng" },
};
