...
} from "../orders/order-command-contract";
export const paymentInputSchema = z
  .object({
    ...businessCommandShape,
    kind: z.enum(["collection", "refund"]),
    amountMinor: moneySchema.refine((n) => n > 0),
...
export const paymentListOutputSchema = z.object({
  rows: z.array(paymentOutputSchema),
});
export const paymentResultOutputSchema = orderOperationOutputSchema;
