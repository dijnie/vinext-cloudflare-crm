...
export const productCategoryCatalogSchema = z.object({
  revision,
  canManage: z.boolean(),
  categories: z.array(productCategoryOutputSchema),
});
...
export type ProductCategoryCatalog = z.infer<
  typeof productCategoryCatalogSchema
>;
export type ProductCategoryMutation = z.infer<
  typeof productCategoryMutationSchema
>;
