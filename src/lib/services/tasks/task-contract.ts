...
export const taskCreateInputSchema = activityAnchorSchema
  .extend({
...
export const taskListInputSchema = z
  .object({
    ...
    state: z.enum(["open", "completed", "all"]).default("open"),
...
export const taskDetailOutputSchema = taskRowSchema.extend({
  cycles: z.array(
    z.object({
