...
export const dashboardInputSchema = z
  .object({ scope: z.enum(["me", "everyone"]).default("me") })
  .strict();
...
export const dashboardSummarySchema = z.object({
  ...
  wonThisMonth: monthly,
  wonPrevMonth: monthly,
  closingThisMonthTotal: monthly,
  performance: z.object({
    windowDays: z.literal(90),
    wins: count,
    losses: count,
    winRate: z.number().nullable(),
    avgDealMinor: money.nullable(),
    avgCycleDays: z.number().nullable(),
  }),
  trend: z.array(
    z.object({ month: z.string(), wonMinor: money, createdMinor: money }),
  ),
  biggestOpen: z.array(
    z.object({
      id: z.string(),
      ...
      stageLabelKey: z.string(),
      company: brief,
      owner: z.object({ membershipId: z.string(), name: z.string() }),
  ...
  overdueTasks: z.array(
    z.object({
      ...
      dueAt: z.string(),
      company: brief.nullable(),
      deal: brief.nullable(),
      lead: brief.nullable(),
      product: brief.nullable(),
      order: brief.nullable(),
    }),
  ),
