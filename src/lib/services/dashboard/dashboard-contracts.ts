...
export const dashboardSummarySchema = z.object({
  ...
  overdueTasks: z.array(z.object({ companyId: z.string().nullable(), contactId: z.string().nullable(), dealId: z.string().nullable(), leadId: z.string().nullable(), productId: z.string().nullable(), id: z.string(), subject: z.string().nullable(), dueAt: z.string(), company: brief.nullable(), deal: brief.nullable(), lead: brief.nullable(), product: brief.nullable() })),
  recentActivity: z.array(z.object({ id: z.string(), type: z.enum(["note", "call", "meeting", "task", "stage_change"]), subject: z.string().nullable(), content: z.string().nullable(), author: brief, createdAt: z.string(), company: brief.nullable(), deal: brief.nullable(), lead: brief.nullable(), product: brief.nullable(), metadata: stageChangeMetadataSchema.nullable() })),
});
